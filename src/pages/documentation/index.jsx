...
class Documentation extends Language {
  ...
  render() {
    const language = this.getLanguage();
    // 开发者页借助文档页载体
    const isDevelop = window.location.pathname.indexOf('/docs/developers/') !== -1;
    ...
    return (
      <div className="documentation-page">
        ...
        />
        <Bar img="https://img.alicdn.com/tfs/TB1sfAnt9zqK1RjSZFHXXb3CpXa-160-160.png" text={dataSource.barText} />
