...
blogs['en-us'] = mdJson['en-us'].filter(md => (
  (!md.meta.hidden || md.meta.hidden === 'false') && md.link.indexOf('download.html') === -1
  ...
  render() {
    ...
    return (
      <div className="blog-list-page">
        ...
        />
        <Bar img="https://img.alicdn.com/tfs/TB1FP7nt9zqK1RjSZFHXXb3CpXa-160-160.png" text={dataSource.barText} />
