...
class BlogItem extends React.Component {
  ...
  render() {
    ...
    return (
      ...
      >
        <div className="title">
          <img src={isHovered ? getLink('https://img.alicdn.com/tfs/TB1jCpLuXzqK1RjSZFoXXbfcXXa-32-40.png') : getLink('https://img.alicdn.com/tfs/TB1OkBRukzoK1RjSZFlXXai4VXa-32-40.png')} />
          <span>{title}</span>
        </div>
